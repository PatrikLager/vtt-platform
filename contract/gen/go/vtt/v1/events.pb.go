...
type SceneCreated struct {
	...
	// shipped map declares one — campaigns/example/maps/cellar.json names
	// cellar-basics (campaigns/example/packs/cellar-basics/pack.json), whose
	// four TILE names are earth-1, masonry-1, flagstone-1 and cellar-door.
	// That path was maps/cellar/map.json until 2026-09-02, when Task 5 of
	// 2026-09-01-create-scene-leaves dissolved the per-map directory.
