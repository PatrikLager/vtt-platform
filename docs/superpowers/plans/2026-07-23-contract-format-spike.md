...
- `003-event-sourced-state.md`: The append-only game log is the source of truth; state is derived, never mutated in place. Only the event-application package writes state. Yields undo, replay, audit, and the LLM context feed.
